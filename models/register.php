...
class AccountRegister{
	...
	private function Register(){
		...
		try{
			...
			$stmt->bindParam(':account_name', $this->form->getAccountName(), PDO::PARAM_STR);
			$stmt->bindParam(':email', $this->form->getEmail(), PDO::PARAM_STR);
			$stmt->bindParam(':password_hash', password_hash($this->form->getPassword(), PASSWORD_DEFAULT), PDO::PARAM_STR);
			$stmt->execute();
